...
public class StudentSettingsActivity extends AppCompatActivity {
    ...
    private static final String PREFS_NAME = "StudentSettingsPrefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Navbar navigation
        navDashboard.setOnClickListener(v -> openActivity(StudentDashboardActivity.class));
        navHome.setOnClickListener(v -> openActivity(StudentHomeActivity.class));
        navEvents.setOnClickListener(v -> openActivity(StudentEventsActivity.class));
    ...
    private void loadUserData(String uid) {
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(StudentSettingsActivity.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
