...
public class ParentSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Navbar navigation
        navDashboard.setOnClickListener(v -> openActivity(ParentDashboardActivity.class));
        navHome.setOnClickListener(v -> openActivity(ParentHomeActivity.class));
        navEvents.setOnClickListener(v -> openActivity(ParentEventsActivity.class));
    ...
    private void loadUserData(String uid) {
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(ParentSettingsActivity.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
