...
public class TeacherSettingsActivity extends AppCompatActivity {
    ...
    private static final String PREFS_NAME = "TeacherSettingsPrefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Navbar navigation
        navDashboard.setOnClickListener(v -> openActivity(TeacherDashboardActivity.class));
        navHome.setOnClickListener(v -> openActivity(TeacherHomeActivity.class));
        navEvents.setOnClickListener(v -> openActivity(TeacherEventsActivity.class));
    ...
    private void loadUserData(String uid) {
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(TeacherSettingsActivity.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
